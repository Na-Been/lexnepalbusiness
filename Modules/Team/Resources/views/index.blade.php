    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-label">Team List
                    <span class="d-block text-muted pt-2 font-size-sm">Available Team List</span></h3>
            </div>
            ...
            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                ...
                @foreach($teams as $team)
                    <tr>
                        ...
                        <td>{{$team->name}}</td>
                        <td>{{$team->position}}</td>
                        <td>{!! Str::limit($team->description,20) !!}</td>
                        <td><img width="45px;" height="25px;"  src="{{$team->getMedia('images')->last()->getFullUrl()}}"></td>
