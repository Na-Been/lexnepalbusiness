        ...
        <form class="form" method="POST" action="{{route('slider.store')}}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control form-control-solid" placeholder="input title"/>
                </div>
                @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="highlight_text" class="form-control form-control-solid"
                           placeholder="input highlight tex"/>
                </div>
                @error('highlight_text')
                <div class="text-danger">{{$message}}</div>
                @enderror
                <div class="form-group">
                    <label>Select In Which Page You Want To Display Slider Image</label><span class="text-danger">*</span>
