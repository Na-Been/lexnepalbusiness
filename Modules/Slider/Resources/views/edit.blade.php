        ...
        <form class="form" method="POST" action="{{route('slider.update',$slider->id)}}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{$slider->name}}" class="form-control form-control-solid"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="highlight_text" value="{{$slider->highlight_text}}"
                ...
                @enderror
                <div class="form-group">
                    <label>Select In Which Page You Want To Display Slider Image</label><span
                        class="text-danger">*</span>
                    <select class="form-control form-control-solid" name="section">
                        <option value="{{$slider->section}}">{{$slider->section}}</option>
                        <option disabled>--Change If You Want To--</option>
                        ...
                        <option value="Cases Study Page">Case Study Page</option>
                    </select>
                </div>
                @error('section')
                <div class="text-danger">{{$message}}</div>
                ...
                <div class="from-group">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="image-input image-input-empty image-input-outline" id="kt_image_5"
                             style="@if($slider->image)
                                 background-image: url({{$slider->getMedia('images')->last()->getFullUrl()}})">
                            @else
