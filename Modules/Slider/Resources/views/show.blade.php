...
@section('content')
    <div class="content">
        ...
        <div class="intro-y news p-5 box mt-8">
            ...
            <div
                class="intro-y text-gray-700 dark:text-gray-600 mt-3 text-xs sm:text-sm"> {{$slider->created_at->format('Y-m-d')}}
                <span
                    class="mx-1">•</span>
            ...
            <div class="intro-y mt-6">
                <div class="news__preview image-fit">
                    @if($slider->image != null)
                        <img class="rounded-md" src="{{url('uploads/slider',$slider->image)}}">
                    @else
            ...
            <div class="intro-y text-justify leading-relaxed">
                <p class="mb-5">{{$slider->highlight_text }}</p>
            </div>
            <div class="intro-y text-justify leading-relaxed">
                <p class="mb-5">{{$slider->section }}</p>
            </div>
            <div
