        ...
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-label">Services List
                    <span class="d-block text-muted pt-2 font-size-sm">Available Services List</span></h3>
            </div>
            ...
            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                ...
                @foreach($services as $service)
                    <tr>
                        ...
                        <td>{{$service->name}}</td>
                        <td><img width="45px;" height="25px;"  src="{{$service->getMedia('images')->last()->getFullUrl()}}"></td>
