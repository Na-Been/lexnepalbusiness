    ...
    <div class="card card-custom">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{route('about.index')}}" class="btn btn-primary font-weight-bolder">
        ...
        <!--begin::Form-->
        <form class="form" method="POST" action="{{route('about.update',$about->id)}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="form-group">
                    <label>Title</label><span class="text-danger">*</span>
                    <input type="text" name="title" value="{{$about->title}}" class="form-control form-control-solid"/>
                </div>
                @error('title')
                ...
                <div class="from-group">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="image-input image-input-empty image-input-outline" id="kt_image_5"
                             style="@if($about->image)
                                 background-image: url({{$about->getMedia('images')->last()->getFullUrl()}})">
                        @else
                ...
                <div class="form-group">
                    ...
                    <div class="card-body">
                        <textarea name="description" id="kt-ckeditor-1">{!! $about->description !!}</textarea>
                    </div>
                </div>
                @error('description')
                <div class="text-danger">{{$message}}</div>
