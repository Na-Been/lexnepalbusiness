    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-label">About Us
                    <span class="d-block text-muted pt-2 font-size-sm">Available About Us Data</span></h3>
            </div>
            ...
            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                ...
                @foreach($abouts as $about)
                    <tr>
                        ...
                        <td>
                            @if($about->image)
                            <img width="45px;" height="25px;"  src="{{$about->getMedia('images')->last()->getFullUrl()}}">
                            @else
                                <img width="45px;" height="25px;"  src="{{asset('dist/default1.jpg')}}">
                            @endif
