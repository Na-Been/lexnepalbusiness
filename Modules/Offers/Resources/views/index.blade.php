    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-label">Offers List
                    <span class="d-block text-muted pt-2 font-size-sm">Available Offer List</span></h3>
            </div>
            ...
            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                ...
                @foreach($offers as $offer)
                    <tr>
                        ...
                        <td>{{$offer->name}}</td>
                        <td><img width="45px;" height="25px;"  src="{{$offer->getMedia('images')->last()->getFullUrl()}}"></td>
                        <td>{{$offer->highlight_text}}</td>
                        <td>{!! Str::limit($offer->description,20) !!}</td>
                        <td nowrap="nowrap">
