...
@section('content')
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form class="form" method="POST" action="{{route('offer.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="highlight_text" class="form-control form-control-solid" placeholder="enter highlight text"/>
                </div>
