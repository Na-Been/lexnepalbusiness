...
@section('content')
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form class="form" method="POST" action="{{route('offer.update',$offer->id)}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="form-group">
                    <label>Name</label><span class="text-danger">*</span>
                    <input type="text" name="name" value="{{$offer->name}}" class="form-control form-control-solid"
                ...
                @enderror
                <div class="form-group">
                    <label>Highlight Text</label><span class="text-danger">*</span>
                    <input type="text" name="highlight_text" value="{{$offer->highlight_text}}"
                           class="form-control form-control-solid" placeholder="enter highlight text"/>
                </div>
                ...
                <div class="from-group">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="image-input image-input-empty image-input-outline" id="kt_image_5"
                             style="@if($offer->image)
                                 background-image: url({{$offer->getMedia('images')->last()->getFullUrl()}})">
                        @else
                ...
                <div class="form-group mt-5">
                    ...
                    <div class="card-body">
                        <textarea name="description" id="kt-ckeditor-1">{!! $offer->description !!}</textarea>
                    </div>
                </div>
                @error('description')
                <div class="text-danger">{{$message}}</div>
