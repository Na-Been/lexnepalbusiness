...
@section('title','Create Performance')
@section('content')
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form class="form" method="POST" action="{{route('performance.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <label>Heading</label><span class="text-danger">*</span>
                    <input type="text" name="heading" class="form-control form-control-solid" placeholder="enter heading"/>
                </div>
                @error('heading')
