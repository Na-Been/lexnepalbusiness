    ...
    <div class="card card-custom">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{route('performance.index')}}" class="btn btn-primary font-weight-bolder">
        ...
        <!--begin::Form-->
        <form class="form" method="POST" action="{{route('performance.update',$performance->id)}}"
              enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="form-group">
                    <label>Heading</label><span class="text-danger">*</span>
                    <input type="text" name="heading" value="{{$performance->heading}}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" value="{{$performance->title}}"
                           class="form-control form-control-solid" placeholder="Example input"/>
                </div>
                @error('title')
                <div class="text-danger">{{$message}}</div>
                ...
                <div class="from-group">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="image-input image-input-empty image-input-outline" id="kt_image_5"
                             style="@if($performance->image)
                                 background-image: url({{$performance->getMedia('images')->last()->getFullUrl()}})">
                            @else
                ...
                <div class="form-group mt-5">
                    ...
                    <div class="card-body">
                        <textarea name="description" id="kt-ckeditor-1">{!! $performance->description !!}</textarea>
                    </div>
                </div>
            </div>
            @error('description')
