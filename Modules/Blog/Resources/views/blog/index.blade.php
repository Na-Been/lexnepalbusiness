    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-label">Blog List
                    <span class="d-block text-muted pt-2 font-size-sm">Available Blog List</span></h3>
            </div>
            ...
            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                ...
                @foreach($blogs as $blog)
                    <tr>
                        ...
                        <td>{{$blog->name}}</td>
                        <td>{{$blog->added_by}}</td>
                        <td><img height="25px;" width="45px" src="{{$blog->getMedia('images')->last()->getFullUrl()}}">
                        </td>
