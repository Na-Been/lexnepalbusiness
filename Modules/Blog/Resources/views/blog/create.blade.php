        ...
        <form class="form" method="POST" action="{{route('blog.store')}}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control form-control-solid" placeholder="Enter Title"/>
                </div>
                @error('name')
                <div class="text-danger">{{$message}}</div>
                @enderror
                <div class="form-group">
                    <label>Added By</label><span class="text-danger">*</span>
                    <input type="text" name="added_by" class="form-control form-control-solid" placeholder="Person name"/>
                </div>
                @error('added_by')
                <div class="text-danger">{{$message}}</div>
                @enderror
