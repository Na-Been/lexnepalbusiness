    ...
    <div class="card card-custom">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{route('cases.index')}}" class="btn btn-primary font-weight-bolder">
        ...
        <form class="form" method="POST" action="{{route('cases.update',$case->id)}}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label>Case Category</label><span class="text-danger">*</span>
                    <select class="form-control form-control-solid" name="category_id">
                        <option value="{{$case->category->id}}">{{$case->category->name}}</option>
                        <option disabled>--Change Category If You Want--</option>
                ...
                @enderror
                <div class="form-group">
                    <label>Case Name</label><span class="text-danger">*</span>
                    <input type="text" value="{{$case->case_name}}" name="case_name"
                ...
                @enderror
                <div class="form-group">
                    <label>Criminal Name</label><span class="text-danger">*</span>
                    <input type="text" name="criminal_name" value="{{$case->criminal_name}}"
                           class="form-control form-control-solid" placeholder="Example input"/>
                </div>
                @error('criminal_name')
                <div class="text-danger">{{$message}}</div>
                @enderror
                <div class="form-group">
                    <label>Defence By</label><span class="text-danger">*</span>
                    <input type="text" name="defence_by" value="{{$case->defence_by}}"
                           class="form-control form-control-solid" placeholder="Example input"/>
                </div>
                @error('defence_by')
                <div class="text-danger">{{$message}}</div>
                @enderror
                <div class="form-group">
                    <label>Crime</label><span class="text-danger">*</span>
                    <input type="text" name="crime" value="{{$case->crime}}" class="form-control form-control-solid"
                ...
                <div class="from-group mt-5">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="image-input image-input-empty image-input-outline" id="kt_image_5"
                             style="@if($case->image)
                                 background-image: url({{$case->getMedia('images')->last()->getFullUrl()}})">
                        @else
                ...
                <div class="form-group mt-5">
                    ...
                    <div class="card-body">
                        <textarea name="description" id="kt-ckeditor-1">{!! $case->description !!}</textarea>
                    </div>
                </div>
                @error('description')
                <div class="text-danger">{{$message}}</div>
