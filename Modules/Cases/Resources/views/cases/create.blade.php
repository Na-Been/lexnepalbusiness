        ...
        <form class="form" method="POST" action="{{route('cases.store')}}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="case_name" class="form-control form-control-solid"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="criminal_name" class="form-control form-control-solid"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="defence_by" class="form-control form-control-solid"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="crime" class="form-control form-control-solid"
