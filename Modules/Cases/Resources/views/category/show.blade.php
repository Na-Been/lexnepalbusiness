    ...
    <div class="content">
        ...
        <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
            ...
            <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                ...
                <a href="{{route('category.index')}}" class="btn btn-primary font-weight-bolder">
										<span class="svg-icon svg-icon-md">
        ...
        <div class="intro-y news p-5 box mt-8">
            ...
            <div
                class="intro-y text-gray-700 dark:text-gray-600 mt-3 text-xs sm:text-sm"> {{$category->created_at->format('Y-m-d')}}
                <span
                    class="mx-1">•</span>
