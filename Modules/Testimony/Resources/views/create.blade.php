...
@section('content')
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form class="form" method="POST" action="{{route('testimony.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <label>Name</label><span class="text-danger">*</span>
                    <input type="text" name="name" class="form-control form-control-solid" placeholder=" input name"/>
                </div>
                @error('name')
