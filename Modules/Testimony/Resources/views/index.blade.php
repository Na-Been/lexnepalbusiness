    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-label">Testimony List
                    <span class="d-block text-muted pt-2 font-size-sm">Available Testimony List</span></h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{route('testimony.create')}}" class="btn btn-primary font-weight-bolder">
            ...
            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                ...
                @foreach($testimonies as $testimony)
                    <tr>
                        ...
                        <td><img width="45px;" height="25px;"  src="{{$testimony->getMedia('images')->last()->getFullUrl()}}"></td>
                        <td>{!!  Str::limit($testimony->description,20)!!}</td>
                        <td nowrap="nowrap">
                            <a href="{{route('testimony.show',$testimony->id)}}">
