    ...
    <div class="page-banner">
        ...
        <div style="height:450px;z-index:0">
            ...
            <div class="page-banner-content">
                <h2 class="text-White text-start blog-detail-title" style="">{{$findService->name}}</h2>
                <div class="d-flex">
                    <div class="t-left">
                        <img width="60" height="60" src="{{$findService->getMedia('images')->last()->getFullUrl()}}"/>
                    </div>
                    <div class="t-right ms-2">

                        <p class=" mb-2 blog-date">{{$findService->created_at->format('Y-m-d')}}</p>
                                ...
                                <li class="d-flex">
                                    ...
                                    <a href="{{route('blog.details',$blog->slug)}}">
                                        <div class="t-right ms-2">
                                            ...
                                            <p class=" mb-2 blog-date">{{$blog->added_by. ' . '.$blog->created_at->format('Y-m-d')}}</p>
