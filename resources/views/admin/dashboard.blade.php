                    ...
                    <div class="col-lg-6 col-xxl-4 order-1 order-xxl-1">
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                                <span
                                                    class="card-label font-weight-bolder text-dark">Tasks Overview</span>
                    ...
                    <div class="col-xxl-8 order-2 order-xxl-1">
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                                <span
                                                    class="card-label font-weight-bolder text-dark">New Arrivals</span>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-header border-0 py-5">
                                <h3 class="card-title align-items-start flex-column">
                                                <span
                                                    class="card-label font-weight-bolder text-dark">Agents Stats</span>
                                    <span class="text-muted mt-3 font-weight-bold font-size-sm">More than 400+ new members</span>
                                </h3>
                                <div class="card-toolbar">
                                        ...
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span
                                                        class="text-muted font-weight-bold">In Proccess</span>
                                                </td>
                                                <td>
                                                                <span
                                                        ...
                                                        <div>
                                                            <a href="#"
                                                               class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">Natali
                                                                Trump</a>
                                                            <span
                                                                class="text-muted font-weight-bold d-block">Python, PostgreSQL, ReactJS</span>
                                                        </div>
                                                    </div>
                                                </td>
